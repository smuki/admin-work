...
import createVue3Core, { fieldProps, SchemaField } from '@/vue3-form-core'

import i18n from '@/utils/i18n'
import * as vueUtils from '@/utils/vue3Utils'
import * as formUtils from '@/utils/formUtils'
import * as schemaValidate from '@/utils/schema/validate'
...
const globalOptions = {
  ...
  COMPONENT_MAP: {
    form: defineComponent({
      ...
      setup(props, { attrs, slots }) {
        ...
        return () => {
          ...
          return h(
            vueUtils.resolveComponent('n-form'),
            {
              ref: formRef,
    ...
    popover: defineComponent({
      setup(props, { attrs, slots }) {
        return () =>
          h(vueUtils.resolveComponent('n-popover'), attrs, {
