<template>
  <div :class="$style.container">
    <div :class="$style.box">
      <el-row :gutter="25">
        <el-col :class="[$style.middleBox]" :span="24">
          <el-card shadow="hover" :class="[$style.card, $style.middleBox_form, $style.formBox]">
            <component
              :is="curVueForm"
              ref="schemaForm"
              :key="pageKey"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        typeItems,
        curVueForm: this.$route.query.ui || 'VueNaiveForm',
    ...
    methods: {
      ...
      initData() {
        ...
        Object.assign(
          this,
          defaultState,
          Object.assign(schemaTypes[this.curType], queryParamsObj, {
            formProps,
          })
        )
      },
