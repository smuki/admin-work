...
import { getUiField, isHiddenWidget, isSelect } from '@/utils/formUtils'
import { nodePath2ClassName, resolveComponent } from '@/utils/vue3Utils'
  ...
  setup(props) {
    return () => {
      ...
      return fieldComponent && !hiddenWidget
        ? h(resolveComponent(fieldComponent), {
            ...curProps,
            fieldProps,
            class: {
