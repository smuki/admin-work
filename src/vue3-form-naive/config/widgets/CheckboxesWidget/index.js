...
import { h } from 'vue'
import { resolveComponent, modelValueComponent } from '@/utils/vue3Utils'
...
const baseComponent = {
  ...
  setup(props, { attrs }) {
    return () =>
      h(resolveComponent('n-checkbox-group'), attrs, {
        default() {
          return h(
            resolveComponent('n-space'),
            {
