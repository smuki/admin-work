...
import { computedCurPath } from '@/utils/vue3Utils'
...
export default {
  ...
  setup(props, { emit, attrs }) {
    ...
    return () => {
      ...
      const { schema, uiSchema, errorSchema, curNodePath, globalOptions } = props
      ...
      const tupleVNodeArr = cutOfArr[0].map((item, index) =>
        h(SchemaField, {
          key: item.key,
          ...props,
      ...
      const trueAddable =
        (addable === undefined ? true : addable) && allowAdditionalItems(props.schema)
