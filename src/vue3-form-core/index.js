...
import { getCurrentInstance, watch, ref, computed, h, provide, toRef } from 'vue'

import { resolveComponent } from '@/utils/vue3Utils'
...
// 基础公共样式
import '@/utils/style/baseForm.css'
    ...
    setup(props, { slots, emit }) {
      ...
      const willReceiveProps = (newVal, oldVal) => {
        if (!deepEquals(newVal, oldVal)) {
          const tempVal = getDefaultFormState(
            props.schema,
            props.modelValue,
            props.schema,
            props.strictMode
