...
// 解析当前节点 ui field
export function getUiField(FIELDS_MAP, { schema = {}, uiSchema = {} }) {
...
export function getUserUiOptions({
  ...
  return Object.assign(
    {},
    ...[schema, uiSchema].map((itemSchema) =>
      Object.keys(itemSchema).reduce((options, key) => {
          ...
          return {
            ...
            [key.substring(3)]:
              curNodePath === undefined
                ? value
                : handleExpression(rootFormData, curNodePath, value, () => value),
          }
        }
...
export function getUserErrOptions({ schema = {}, uiSchema = {}, errorSchema = {} }) {
  return Object.assign(
    {},
    ...[schema, uiSchema, errorSchema].map((itemSchema) =>
      Object.keys(itemSchema).reduce((options, key) => {
        const value = itemSchema[key]
        // options 内外合并
