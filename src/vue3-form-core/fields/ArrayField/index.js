...
import { allowAdditionalItems, isFixedItems, isMultiSelect } from '@/utils/formUtils'
import { getPathVal, setPathVal } from '@/utils/vue3Utils'
...
export default {
  ...
  setup(props) {
    ...
    return () => {
      const { schema, uiSchema, rootSchema, rootFormData, curNodePath, globalOptions } = props
